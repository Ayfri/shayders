<script lang="ts">
	...
	import ShaderCanvasToolbar from '$lib/components/ShaderCanvasToolbar.svelte';
	import ShaderInfoModal from '$lib/components/ShaderInfoModal.svelte';
	import { FULLSCREEN_TOGGLE_KEY } from '$lib/shader-domain';
	import { ShaderCanvasRuntime } from '$lib/shader-canvas/runtime';
